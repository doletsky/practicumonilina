...
!function (e) {
    ...
    function a() {
        e("*[data-pattern-overlay-darkness-opacity]").each(function () {
            ...
            e(this).css("background-image", "url('./images/files/parallax-bg/" + a + "')")
        })
    }
    ...
    function n() {console.log('n function');
        ...
        }), e("[class*='anim-movebottom']").each(function (a) {console.log('anim-movebottom');
            var t = e(this), n = t.data("opacity-value"), i = t.data("move-distance") ? t.data("move-distance") : 30;
    ...
    function w() {
        var a = e(".banner-parallax"), t = a.children("img:first-child").attr("src");
        a.prepend("<div class='bg-element'></div>"), a.find("> .bg-element").css("background-image", "url('" + t + "')").attr("data-stellar-background-ratio", .2)
    }
    ...
    function D() {
        ...
        }, 2e3), e(".demos-preview li a").each(function () {
            var a = e(this);
            a.hover(function () {
                var t = a.find("img").attr("src");
                e(".dp-img").attr("src", t).toggleClass("appeared")
            })
        ...
        }), e(".logo-option .switch-button").each(function () {
            e(this).on("click", function () {
                e(".logo").toggleClass("logo-text")
            }), e(this).prev("span").on("click", function () {
                e(".logo").removeClass("logo-text")
            }), e(this).next("span").on("click", function () {
                e(".logo").addClass("logo-text")
            })
        }), e(".header-option .switch-button").each(function () {
            e(this).on("click", function () {
                e("#header").toggle(0), y()
            }), e(this).prev("span").on("click", function () {
                e("#header").hide(0), y()
        ...
        }), e(".banner-rb-option .switch-button").each(function () {
            e(this).on("click", function () {
                e("#banner").toggleClass("rounded-bottom")
            }), e(this).prev("span").on("click", function () {
                e("#banner").addClass("rounded-bottom")
            }), e(this).next("span").on("click", function () {
                e("#banner").removeClass("rounded-bottom")
            })
        })
    }

    function I() {
        e("<div class='style-switcher'></div>").insertAfter("#full-container"), e("<link href='css/skins/preview/skin-default.css' rel='stylesheet'>").insertAfter(e("link").attr("style", "css/style.css"));
        e(".style-switcher").load("switcher.html", function () {
            e(this).append("<img class='dp-img' src='images/files/style-switcher/img-1.jpg'>"), D();
            var a = document.querySelector(".style-switcher-content");
            SimpleScrollbar.initEl(a)
        })
    }
    ...
    e(document).on("ready", function () {
        t(), a(), i(), o(), c(), r(), u(), m(), d(), h(), p(), v(), g(), y(), w(), C(), b(), l(), T(), E(), x(), k(), S(), f()
