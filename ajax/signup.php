...
$defaults = array('first_name' => '', 'last_name' => '', 'phone' => '', 'email' => '');
    ...
    $queryData = http_build_query(array('fields' => array("TITLE" => ' ', "NAME" => "", "LAST_NAME" => "", "STATUS_ID" => "NEW", "OPENED" => "Y", "ASSIGNED_BY_ID" => 1,  "EMAIL" => array(array("VALUE" => $_REQUEST['EMAIL'], "VALUE_TYPE" => "WORK")),), 'params' => array("REGISTER_SONET_EVENT" => "Y")));
    $curl = curl_init();
